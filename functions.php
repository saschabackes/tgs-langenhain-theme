...
function tgs_fix_shortcode_wpautop( $content ) {
    $shortcodes = array(
        ...
        'tgs_chips', 'tgs_infobox', 'tgs_gruppen', 'tgs_cta_box', 'tgs_whatsapp', 'tgs_kurs_bewertungen', 'tgs_kurs_meldungen', 'tgs_breadcrumb', 'tgs_beitraege', 'tgs_mitglied_werden', 'tgs_gaststaette', 'tgs_speisekarte', 'tgs_kontakt',
    );
