...
function tgs_kurs_meta_box_html( $post ) {
    ...
    $fields = array(
        ...
        '_tgs_status'          => array( 'label' => 'Status', 'type' => 'select', 'options' => array( 'frei' => 'Freie Plätze', 'warteliste' => 'Warteliste' ) ),
        '_tgs_max_teilnehmer'  => array( 'label' => 'Max. Teilnehmer', 'type' => 'number' ),
